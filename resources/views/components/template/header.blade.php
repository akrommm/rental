<div class="header">
    ...
    <div class="logo logo-white">
        <a href="{{ url('admin/dashboard') }}">
            <img src="" alt="Logo" width="25%" height="57" class="m-5">
            <img class="logo-fold mt-2 ml-3" src="" alt="Logo" width="70%" height="57">
        </a>
    </div>
    <div class="nav-wrap">
        <ul class="nav-left">
                ...
                <div class="p-b-15 p-t-20 dropdown-menu pop-profile">
                    <div class="p-h-20 p-b-15 m-b-10 border-bottom">
                        <div class="d-flex align-items-center">
                            <div class="m-l-10">
                                <p class="text-dark font-weight-semibold mb-0">Admin</p>
                            </div>
                        </div>
                    </div>
